...
class InvalidOperationExceptionTest extends TestCase
{
    ...
    {
        $exception = new InvalidOperationException('t', ['a' => 1, 'b' => 2]);
    ...
    public function test_construct_with_full_construct(): void
    {
        ...
        $exception = new InvalidOperationException($message, $context, $code, $prev);
    ...
    {
        $exception = new InvalidOperationException('t', null);
        self::assertEquals('t', $exception->getMessage());
